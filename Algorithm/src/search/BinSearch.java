...
/*
1. 이진검색(binary search)이란?
0101 같은 이진법의 이진이 아니라, 목록의 반을 잘라가며 사용한다고 해서 이진 검색이라고 한다.
이와 같은 특성 때문에 이진검색을 하려면 "반드시" 요소가 오름차순 또는 내림차순으로 정렬되어 있어야 한다.
이진검색의 시간 복잡도는 O(log n)이다.
*/
